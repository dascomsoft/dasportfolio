...
//     e.preventDefault();
//     alert('Formulaire soumis! (Fonctionnalité EmailJS à implémenter)');
...
//                   />
//                   {/* Overlay flou pour le nom et les technologies */}
...
//                 <button
//                   type="submit"
//                   className="px-6 py-2 cursor-auto bg-amber-500 hover:bg-amber-600 text-white font-medium rounded-md transition-colors duration-300"
//                 >
//                   Submit
//                 </button>
//               </form>
